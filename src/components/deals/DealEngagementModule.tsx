    ...
    <div className="space-y-6">
      ...
      <div className="glass-card rounded-2xl border border-pw-border p-6 space-y-5 relative overflow-hidden">
        ...
        {responseMode === 'COMMITTED' && (
          <div className="p-5 rounded-xl bg-emerald-500/10 border border-emerald-500/30 space-y-3 animate-fade-in">
            <div className="flex items-center gap-3">
            ...
            <div className="p-3 rounded-lg bg-black/40 border border-emerald-500/20 text-xs font-mono text-slate-300 space-y-1">
            ...
            {intentInputType === 'AMOUNT' ? (
              <div className="space-y-1">
                ...
                <input
                  ...
                  placeholder="25000"
                  className="w-full px-4 py-2.5 rounded-xl bg-white/5 border border-pw-border text-slate-100 text-sm font-mono focus:border-emerald-500 focus:outline-none"
                />
              </div>
            ) : (
              <div className="space-y-1">
            ...
            <form onSubmit={handleSendInvite} className="space-y-3">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-2.5 rounded-xl bg-white/5 border border-pw-border text-slate-100 text-sm focus:border-emerald-500 focus:outline-none"
                />
                <button
                  type="submit"
          ...
          <div className="glass-card rounded-2xl border border-pw-border max-w-md w-full p-6 space-y-5 animate-scale-up">
            ...
            <div className="p-4 rounded-xl bg-slate-900 border border-pw-border space-y-2">
              <div className="flex items-center justify-between">
                <span className="text-[10px] font-bold uppercase text-emerald-400">PaperWorking Teaser</span>
