# Persona Experience Report — Chloe Nguyen (P-08)

## 1. Agent Overview
- **Persona ID:** P-08
- **Full Name:** Chloe Nguyen
- **Email:** agent08.chloe.nguyen@paperworking-test.dev
- **Entity / LLC:** BrightHaus Flips LLC
- **Category:** house_flipper
- **Primary Market:** Denver, CO
- **Investor Archetype:** Rookie Cautious Flipper
- **Subscription Tier:** Individual ($59/mo)
- **Plaid Sandbox:** N/A
- **Temperament Score:** 9/10 (Cautious & Risk-Averse)

## 2. Bio & Investment Criteria
- **Bio:** Denver rookie flipper on 3rd project. Obsessed with margin safety, contingency planning, and hard money loan interest calculations. Needs step-by-step guidance.
- **Target Return:** 18% Margin (Conservative)
- **Strategy:** Entry-Level Fix & Flip
- **Check Size Range:** $60,000 – $300,000
...
> "As Chloe Nguyen, operating BrightHaus Flips LLC out of Denver, CO, I evaluate software strictly by how fast it gets me from raw lead to closed deal. My focus is Entry-Level Fix & Flip with a target check size of $60,000 to $300,000."
