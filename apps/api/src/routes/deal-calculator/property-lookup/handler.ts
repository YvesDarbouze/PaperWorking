...
} from '../../../lib/deal-calculator/property-lookup.js';
...
export interface DealCalculatorPropertyLookupPostDeps {
  lookupProperty?: LookupPropertyDataFn;
}

/**
 * POST /api/deal-calculator/property-lookup
 */
export async function handleDealCalculatorPropertyLookupPost(
  body: { address?: unknown },
  context: { cookie?: string | null; e2eHeader?: string | null } = {},
  deps: DealCalculatorPropertyLookupPostDeps = {},
): Promise<RouteResult> {
  ...
  try {
    ...
    console.error('[POST /api/deal-calculator/property-lookup] Error:', message);
