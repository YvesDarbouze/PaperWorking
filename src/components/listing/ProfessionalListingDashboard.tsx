...
const ProfessionalListingDashboard: React.FC<ProfessionalListingDashboardProps> = ({ deal }) => {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto space-y-16 animate-in fade-in duration-700 pb-32">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-px bg-pw-border border-l border-t border-border-accent">
        
        {/* ── Asset Content (Media & Specification) ── */}
        <div className="lg:col-span-2 space-y-px bg-pw-border border-r">
          
          {/* Media Engine Panel */}
          <div className="bg-bg-primary p-8 border-b border-border-accent">
            <div className="border border-border-accent p-3 bg-bg-surface shadow-inner">
          ...
          <div className="bg-bg-surface p-14 space-y-12 h-full min-h-[500px]">
            ...
            <div className="relative">
              {aiDescription ? (
                ...
                <div className="border-2 border-dashed border-border-accent bg-bg-primary p-24 text-center grayscale opacity-60">
        ...
        <div className="space-y-px bg-pw-border border-r border-b">
          ...
          <div className="bg-pw-black p-12 text-pw-white h-full">
            ...
            <div className="grid grid-cols-3 border border-pw-white/10 mb-16 bg-bg-surface/5">
            ...
            <div className="space-y-6">
              ...
              {(neighborhood?.schools || []).map((school, i) => (
                <div key={i} className="flex justify-between items-center group p-4 hover:bg-bg-surface/5 border border-transparent hover:border-pw-white/10 transition-all">
            ...
            <div className="mt-16 p-10 bg-bg-surface text-text-primary border border-pw-white shadow-2xl relative overflow-hidden">
               <div className="absolute -right-8 -bottom-8 opacity-5">
                  <Home className="w-32 h-32" />
               </div>
               <p className="text-xs font-black text-text-secondary uppercase tracking-[0.4em] mb-4">ESTIMATED ASSET_CEILING</p>
               <p className="text-5xl font-black text-text-primary tracking-tighter mb-10 font-mono">
