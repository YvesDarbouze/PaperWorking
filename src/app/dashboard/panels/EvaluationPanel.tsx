...
export default function EvaluationPanel() {
  ...
  const shimmer = (
    <div className="h-40 border border-pw-border bg-pw-surface animate-pulse flex items-center justify-center">
       <span className="text-[10px] font-black text-pw-muted uppercase tracking-[0.3em]">Module_Syncing...</span>
    </div>
  );

  if (!currentProject) {
    return (
      <div className="flex flex-col items-center justify-center h-full text-center p-20 bg-pw-bg border-x border-pw-border">
         ...
         <h1 className="text-xl font-black text-pw-black tracking-widest uppercase mb-2">Target_Required</h1>
         <p className="text-xs text-pw-muted font-bold uppercase tracking-widest leading-relaxed max-w-xs">
  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8 pt-10 pb-20 max-w-6xl mx-auto space-y-12 bg-pw-bg border-x border-pw-border min-h-full">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-pw-black pb-8">
        <div>
          <div className="flex items-center space-x-2 mb-2">
            ...
            <p className="text-[10px] font-black text-pw-muted uppercase tracking-[0.5em]">Phase_01: Find & Fund</p>
          </div>
          <h1 className="text-4xl font-black text-pw-black tracking-tighter uppercase leading-none">Market.Intelligence</h1>
          <p className="text-[10px] font-bold text-pw-muted uppercase mt-3 tracking-widest">
            Capital sourcing and arithmetic modeling for <span className="text-pw-black">{currentProject.propertyName}</span>
          </p>
        </div>
        <div className="text-right hidden md:block">
           <p className="text-[10px] font-black text-pw-muted uppercase tracking-widest mb-1">Entity_ID</p>
           <p className="text-xs font-mono font-black text-pw-black">{currentProject.id}</p>
        </div>
      </div>
      ...
      <section className="space-y-6">
         <div className="flex items-center justify-between border-b border-pw-border pb-4">
            ...
            <span className="text-[10px] text-pw-muted font-bold tracking-widest">v4.2_ENGINE</span>
         </div>
         <Suspense fallback={shimmer}>
           <MarketAnalysis />
         </Suspense>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="border border-pw-border p-8 bg-pw-surface flex flex-col justify-center">
          <HoldingCostClock />
        </div>
        <div className="border border-pw-border p-8 bg-pw-surface">
           <RuleOf70Warning />
        </div>
      </div>
      ...
      <Suspense fallback={shimmer}>
        <div className="border border-pw-black bg-pw-surface p-8 shadow-2xl relative overflow-hidden">
           <div className="absolute top-0 right-0 p-4 opacity-5">
              <span className="text-8xl font-black text-pw-black">70</span>
           </div>
           <SeventyPercentRule />
        </div>
      </Suspense>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-5 space-y-8">
          <div className="border-l-2 border-pw-accent pl-6 py-2">
            <h3 className="text-xs font-black text-pw-black uppercase tracking-widest mb-1">Scenario_Modeling</h3>
            <p className="text-[10px] text-pw-muted font-bold uppercase">Dynamic debt vs equity simulations</p>
          </div>
      ...
      <section className="pt-10 space-y-6">
        <div className="bg-pw-surface border border-pw-border p-10">
          <div className="flex items-center justify-between mb-10 pb-6 border-b border-pw-border">
            <div>
              <h2 className="text-2xl font-black text-pw-black tracking-tighter uppercase">Investor.Cap_Table</h2>
              <p className="text-[10px] text-pw-muted font-bold uppercase mt-1 tracking-widest">Fractional equity allocation and commitment mapping.</p>
            </div>
            <button
