...
export const SUPPORT_FAQS: SupportFAQ[] = [
  {
    id: 'faq-1',
    categoryId: 'find-and-fund',
    question: 'I\'m not tech-savvy. Will PaperWorking be too complicated for me?',
    answer: 'We built PaperWorking specifically for real estate investors, not software engineers. If you can use email, you can use our platform. We cut out the clutter so you can focus on your deals. Plus, our onboarding team is here to help you migrate your first project from your old spreadsheets.',
  },
  {
    id: 'faq-2',
    categoryId: 'financials',
    question: 'How does the 14-day free trial work? Is there any risk?',
    answer: 'Your 14-day trial is completely risk-free. You get full access to every feature so you can see exactly how PaperWorking streamlines your business. There are no surprise charges, no long-term contracts, and you can cancel anytime with a single click—no questions asked.',
  },
  {
    id: 'faq-3',
    categoryId: 'rehab',
    question: 'Will this actually save me money on my projects?',
    answer: 'Yes. By tracking your daily burn rate, preventing contractor budget overruns, and ensuring you never miss a contingency deadline, PaperWorking often pays for itself on your very first deal. You stop the invisible cash bleed that kills profit margins.',
  },
  {
    id: 'faq-4',
    categoryId: 'compliance',
    question: 'Is my financial data and investor roster secure?',
    answer: 'Bank-level security is our baseline. Your data is encrypted, and our Role-Linked access means your contractors only see their scopes of work, and your accountant only sees the financials. You maintain total control over who sees what, always.',
  },
  {
    id: 'faq-5',
    categoryId: 'exit',
    question: 'Can I really replace all my other software tools?',
    answer: 'That\'s exactly what we designed it to do. Instead of duct-taping together CRMs, file storage, project management, and accounting tools, PaperWorking gives you a single, unified command center to run your entire real estate portfolio.',
  },
];
