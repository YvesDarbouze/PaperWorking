...
export const projectSchema = z.object({
  ...
  /**
   * Current lifecycle phase as a NUMBER (1-4).
   * 1 = Find & Fund, 2 = Acquisition, 3 = Hold & Rehab, 4 = Closing & Exit.
   * CRITICAL: This is a number, NOT a string enum. 40+ components depend on this.
   */
  ...
  /** Rehab module — budget, tasks, permits, draws */
  rehab: z.any().optional(),
