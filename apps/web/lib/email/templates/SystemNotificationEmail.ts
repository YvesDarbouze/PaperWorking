...
/**
 * Loose actor reference carried by system notifications (legacy shape).
 */
export interface SystemNotificationObjectReference {
  dealAddress?: string;
...
export interface SystemNotificationEmailProps {
  ...
  appUrl?: string;
  type?: string;
  objectReference?: SystemNotificationObjectReference;
  actorName?: string;
}
