  ...
  activity: [
    {
      id: 'act-1',
      type: 'user_signup',
      title: 'New investor signup',
      detail: 'bob@capital.test joined Individual plan',
    ...
    },
    {
      ...
      type: 'payment',
      title: 'Invoice paid',
      detail: 'Atlas Syndicate — $499 Team',
      at: '2026-08-21T16:05:00.000Z',
    },
    {
      id: 'act-3',
      type: 'ticket',
      title: 'Ticket claimed',
      detail: 'SUP-1842 assigned to Support Lead',
      at: '2026-08-21T14:40:00.000Z',
    },
    {
      id: 'act-4',
      type: 'audit',
      title: 'Admin impersonation',
      detail: 'admin impersonated Scout for QA',
