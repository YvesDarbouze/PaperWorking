...
export default function WhatIfSimulator() {
  ...
  return (
    <div className="bg-gradient-to-br from-[#182127]/60 to-[#0d0a0b]/80 border border-white/10 rounded-xl p-6 shadow-xl text-white backdrop-blur-md">
      <div className="flex items-center justify-between border-b border-white/10 pb-4 mb-6">
        <div className="flex items-center space-x-2">
          <SlidersHorizontal className="w-5 h-5 text-[#20B2AA]" />
          <h3 className="text-lg font-semibold tracking-wide">"What-If" Stress Test</h3>
        </div>
        <span className="text-xs bg-[#20B2AA]/20 text-[#20B2AA] px-2 flex items-center py-1 rounded">
      ...
      <div className="mb-8">
        <div className="flex justify-between items-end mb-2">
           <label className="text-sm font-medium text-slate-300">Timeline Delay Simulator</label>
        ...
        <input 
           ...
           className="w-full h-2 bg-[#0d0a0b] rounded-lg appearance-none cursor-pointer accent-[#20B2AA]"
        />
