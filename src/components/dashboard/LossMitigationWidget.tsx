...
const LossMitigationWidget: React.FC<LossMitigationWidgetProps> = ({ 
  ...
  return (
    <div className="ag-card bg-pw-surface shadow-[0_30px_60px_rgba(0,0,0,0.02)] border border-pw-border/10 p-10 flex flex-col h-full min-h-[500px]">
      <div className="flex items-center space-x-5 mb-10">
        ...
        <div>
          ...
          <h2 className="text-3xl font-light text-pw-black tracking-tighter">
            Mitigation Required
          </h2>
        </div>
      </div>

      <p className="text-sm text-pw-muted font-normal mb-8 leading-relaxed">
        ...
        {criticalDeals.map(deal => {
          ...
          return (
            <div 
              ...
              className="flex items-center justify-between bg-pw-bg/30 border border-pw-border/10 p-6 rounded-[32px] hover:bg-pw-bg/50 transition-all cursor-pointer group"
            >
              <div className="flex items-center space-x-5">
                <div className="w-10 h-10 rounded-full bg-pw-white border border-pw-border/10 flex items-center justify-center text-pw-muted group-hover:bg-pw-black group-hover:text-pw-white transition-all duration-500 shadow-sm">
                  <Home className="w-4 h-4" />
                </div>
                <div>
                  <p className="text-base font-medium text-pw-black tracking-tight leading-none mb-1">
                    {deal.propertyName}
                  </p>
                  <p className="text-xs text-pw-muted opacity-60 font-medium">
              ...
              <div className="text-right flex items-center space-x-6">
                <div>
                  <p className="text-[10px] font-bold text-pw-muted uppercase tracking-[0.1em] mb-1 opacity-40 text-right">Deficit</p>
                  <p className="text-lg font-medium text-pw-black tracking-tighter">
                    {formatCentsToDollars(Math.abs(deficit))}
                  </p>
                </div>
                <ArrowRight className="w-5 h-5 text-pw-muted opacity-20 group-hover:opacity-100 group-hover:text-pw-black transition-all" />
              </div>
            </div>
          );
        })}
      ...
      <div className="mt-10 pt-8 border-t border-pw-border/10 flex justify-between items-center text-xs">
        <span className="text-pw-muted font-medium opacity-60">Action Required: Audit line-items.</span>
        <button className="text-pw-black font-bold uppercase tracking-widest text-[9px] hover:underline transition-all">
          Audit Full Stack
        </button>
      </div>
    </div>
