/**
 * Email message classes (essential / optional / commercial) carried over from the
 * legacy envelope contract; with the commercial class comes a CAN-SPAM footer.
 */
export type MessageClass = 'E' | 'O' | 'C';

/**
 * CAN-SPAM physical postal address used in commercial-class footers.
 */
