/** Team directory visual tokens — access & seat ops desk. */

import type { CSSProperties } from 'react';

export function teamTokens(isDark: boolean) {
  return {
...
export type TeamTokens = ReturnType<typeof teamTokens>;

export function panelStyle(t: TeamTokens): CSSProperties {
  return {
...
export function inputStyle(t: TeamTokens): CSSProperties {
  return {
