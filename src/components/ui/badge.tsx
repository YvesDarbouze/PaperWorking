    ...
    <div
      className={cn(
        "inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 uppercase tracking-wider",
        {
          ...
          "bg-[#F2F2F2] text-[#1A1A1A] hover:bg-[#F2F2F2]/80": variant === "secondary",
          "text-[#1A1A1A] border border-[#A5A5A5]": variant === "outline",
          "bg-[#CCCCCC] text-[#1A1A1A] border-transparent": variant === "success",
          "bg-[#F2F2F2] text-[#595959] border border-[#A5A5A5]": variant === "warning",
          "bg-[#A5A5A5] text-[#1A1A1A] border-transparent": variant === "destructive" || variant === "overdue",
        },
        className
      )}
      {...props}
