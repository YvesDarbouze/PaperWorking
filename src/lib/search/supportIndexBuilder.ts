import { SUPPORT_ARTICLES, SUPPORT_CATEGORIES, SUPPORT_FAQS } from '../cms/supportData';
import { GLOSSARY_TERMS } from '../cms/glossaryData';
import { FAQ_ITEMS } from '../cms/faqData';
...
// Canonical metrics list matching /support/metrics
...
/**
 * Builds the search index from REAL content sources:
 * - SUPPORT_ARTICLES (~26 articles)
 * - GLOSSARY_TERMS
 * - METRICS_LIST
 * - SUPPORT_FAQS & FAQ_ITEMS
 */
export function buildSupportSearchIndex(): SearchDocument[] {
...
// Built-in static index evaluation for fast client execution
export const STATIC_SUPPORT_INDEX = buildSupportSearchIndex();
