    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-5 flex flex-col">
        <div className="flex items-center gap-2 mb-3">
          <Target className="w-4 h-4 text-pw-subtle" />
          <p className="text-xs font-medium uppercase tracking-widest text-gray-500">Target ARV</p>
        </div>
        <p className="text-3xl font-light tracking-tight text-gray-900 mb-2">
      ...
      <div className={`rounded-xl shadow-sm border border-gray-200 p-5 flex flex-col ${contBg}`}>
        <div className="flex items-center gap-2 mb-3">
      ...
      <div className={`rounded-xl shadow-sm border border-gray-200 p-5 flex flex-col ${roiBg}`}>
        <div className="flex items-center gap-2 mb-3">
          <TrendingUp className={`w-4 h-4 ${roiColor}`} />
          <p className="text-xs font-medium uppercase tracking-widest text-gray-500">Projected ROI</p>
        </div>
