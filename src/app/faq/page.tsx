...
/* ═══════════════════════════════════════════════════════
   ...
   A standalone SEO page covering common house flipping
   questions and industry insights, tied back to
   PaperWorking features.
   ═══════════════════════════════════════════════════════ */
    ...
    <div className="min-h-screen" style={{ background: 'var(--bg-canvas)' }}>
      ...
      <main className="max-w-4xl mx-auto px-6 pt-32 pb-24">
        ...
        <section className="mb-20 text-center max-w-3xl mx-auto">
          ...
          <div className="mt-8 flex items-center justify-center gap-2 text-xs font-medium" style={{ color: 'var(--text-secondary)' }}>
