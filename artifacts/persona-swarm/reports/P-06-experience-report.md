# Persona Experience Report — Samantha Sam Ortega (P-06)

## 1. Agent Overview
- **Persona ID:** P-06
- **Full Name:** Samantha Sam Ortega
- **Email:** agent06.samantha.ortega@paperworking-test.dev
- **Entity / LLC:** SO Renovations LLC
- **Category:** house_flipper
- **Primary Market:** Atlanta, GA
- **Investor Archetype:** Design-Focused Historic Flipper
- **Subscription Tier:** Individual ($59/mo)
- **Plaid Sandbox:** N/A
- **Temperament Score:** 7/10 (Highly Analytical & Detail-Oriented)

## 2. Bio & Investment Criteria
- **Bio:** Atlanta historic rehab flipper in Inman Park and Grant Park. High attention to architectural finish, requires detailed photo/document attachment and subcontractor milestone tracking.
- **Target Return:** 24% Net Margin
- **Strategy:** Historic Gut Rehab & Flip
- **Check Size Range:** $75,000 – $450,000
- **Asset Focus:** Single Family, Historic Home
...
> "As Samantha Sam Ortega, operating SO Renovations LLC out of Atlanta, GA, I evaluate software strictly by how fast it gets me from raw lead to closed deal. My focus is Historic Gut Rehab & Flip with a target check size of $75,000 to $450,000."
