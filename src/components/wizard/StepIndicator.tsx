  ...
  return (
    <div className="w-full space-y-4">
      ...
      <div className="w-full h-1.5 bg-white/5 rounded-full overflow-hidden">
        <div
          className="h-full bg-[#7A9EAA] transition-all duration-500 ease-out"
              ...
              >
                <div
                  className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold transition-all border ${
                    isActive
                      ? 'bg-[#7A9EAA] border-[#a0c6ff] text-[#0d0a0b] shadow-[0_0_12px_rgba(122,158,170,0.3)]'
                      : isCompleted
                      ? 'bg-[#7A9EAA]/10 border-[#7A9EAA]/30 text-[#7A9EAA]'
                      : isClickable
