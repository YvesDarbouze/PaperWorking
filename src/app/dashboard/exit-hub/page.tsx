...
import { Camera, Link as LinkIcon, DollarSign, Percent, CheckCircle, ExternalLink, BadgePercent, ArrowRight } from 'lucide-react';
...
export default function ExitHubPage() {
  ...
  if (!currentDeal) {
    return <div className="p-8 text-center text-gray-500 bg-black min-h-screen">No properties available for The Exit Phase.</div>;
  }
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-emerald-500/30 font-sans pb-32">
       
       {/* Premium Dark Nav */}
       <header className="border-b border-gray-800 bg-black/50 backdrop-blur-md sticky top-0 z-20">
          <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
             <div className="flex items-center space-x-4">
                ...
                <div>
                   <h1 className="text-lg font-light tracking-wide text-gray-200">The Exit Hub</h1>
                </div>
             </div>
       ...
       <main className="max-w-6xl mx-auto px-6 py-10 animate-in fade-in slide-in-from-bottom-8 duration-700">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
             ...
             <div className="lg:col-span-5 space-y-8">
                ...
                <div className="bg-[#111] border border-gray-800 rounded-2xl p-6 shadow-2xl relative">
                   ...
                   <div className="space-y-5">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <label className="text-[10px] uppercase tracking-wider text-gray-500 block mb-1">Buyer's Agent Comm.</label>
                          <div className="relative">
                        ...
                        <div>
                          <label className="text-[10px] uppercase tracking-wider text-gray-500 block mb-1">Seller's Agent Comm.</label>
                          <div className="relative">
