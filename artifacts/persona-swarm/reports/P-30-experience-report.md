# Persona Experience Report — Ingrid Sorensen (P-30)

## 1. Agent Overview
- **Persona ID:** P-30
- **Full Name:** Ingrid Sorensen
- **Email:** agent30.ingrid.sorensen@paperworking-test.dev
- **Entity / LLC:** Sorensen Income Properties LLC
- **Category:** commercial_investor
- **Primary Market:** Seattle, WA
- **Investor Archetype:** Industrial Flex Landlord
...
- **Bio:** Seattle industrial flex warehouse investor. Integrates Plaid banking to track monthly NNN tenant lease receipts, CAM reconciliations, and debt service ratios.
- **Target Return:** 6.8% Cap Rate / Industrial NNN
- **Strategy:** Industrial Flex Warehouse NNN
- **Check Size Range:** $400,000 – $3,500,000
- **Asset Focus:** Industrial Flex, Warehouse
...
> "As Ingrid Sorensen, operating Sorensen Income Properties LLC out of Seattle, WA, I evaluate software strictly by how fast it gets me from raw lead to closed deal. My focus is Industrial Flex Warehouse NNN with a target check size of $400,000 to $3,500,000."
...
### Project Creation UX
- Successfully created 10 projects tailored to Seattle, WA on production Firestore. Document uploads with synthetic PDF scope watermarks uploaded instantly.
...
1. **Saved Filter Presets:** Allow saving custom filter views specifically tuned for Industrial Flex assets.
