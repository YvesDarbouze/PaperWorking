...
const UPDATES = [
  {
    ...
    body: 'Deals now move through Acquisition → Fund → Hold → Exit in strict order. Each phase gate requires the previous phase to be marked complete before advancing. This keeps your pipeline reviewable and prevents data gaps that cause problems at closing or tax time.',
    link: '/changelog',
  },
  {
    date: 'May 28, 2026',
