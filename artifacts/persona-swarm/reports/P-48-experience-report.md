# Persona Experience Report — Gus Antonopoulos (P-48)

## 1. Agent Overview
- **Persona ID:** P-48
- **Full Name:** Gus Antonopoulos
- **Email:** agent48.gus.antonopoulos@paperworking-test.dev
- **Entity / LLC:** Antonopoulos Bridge Capital LLC
- **Category:** hard_money_lender
- **Primary Market:** Denver, CO
- **Investor Archetype:** Private Debt Lender
- **Subscription Tier:** Individual ($59/mo)
- **Plaid Sandbox:** N/A
- **Temperament Score:** 4/10 (Highly Analytical & Detail-Oriented)

## 2. Bio & Investment Criteria
- **Bio:** Denver hard money lender ($20M loan book). Issues short-term bridge debt (2 pts + 12% APR) for rehabs and flips. Tracks LTV thresholds and draw schedules.
- **Target Return:** 12.0% APR + 2 Pts
- **Strategy:** Private Hard Money Debt Origination
- **Check Size Range:** $100,000 – $1,500,000
- **Asset Focus:** Hard Money Bridge Loan
...
- **Wave 4 (Collaboration & Network):** PASS (6 Deal Interactions Executed, 2 Team Invites Accepted)

## 4. First-Person UX Narrative & Persona Voice
> "As Gus Antonopoulos, operating Antonopoulos Bridge Capital LLC out of Denver, CO, I evaluate software strictly by how fast it gets me from raw lead to closed deal. My focus is Private Hard Money Debt Origination with a target check size of $100,000 to $1,500,000."
...
- Sent 2 team invites and participated in 6 deal interaction edges across the PaperWorking network.
...
1. **Saved Filter Presets:** Allow saving custom filter views specifically tuned for Hard Money Bridge Loan assets.
