          ...
          >
            <div className="p-8">
              ...
              <p className="text-sm text-gray-500 mb-8 leading-relaxed">
                You are about to transition <span className="font-bold text-gray-900">"{dealName}"</span> to the 
              ...
              <div className="flex flex-col space-y-3">
                ...
                <button
                  onClick={onClose}
                  className="w-full py-4 bg-gray-50 text-gray-500 rounded-2xl font-bold text-xs uppercase tracking-widest hover:bg-gray-100 transition-all"
                >
                  Cancel
                </button>
              </div>
            ...
            {/* Visual Footer */}
            <div className="bg-gray-50 px-8 py-4 border-t border-gray-100 flex items-center justify-center italic text-xs text-gray-400">
