# Persona Experience Report — Rosa Castillo (P-38)

## 1. Agent Overview
- **Persona ID:** P-38
- **Full Name:** Rosa Castillo
- **Email:** agent38.rosa.castillo@paperworking-test.dev
- **Entity / LLC:** Castillo Legacy Investments LLC
- **Category:** passive_lp
- **Primary Market:** Washington, DC
- **Investor Archetype:** Impact LP Investor
- **Subscription Tier:** Individual ($59/mo)
- **Plaid Sandbox:** N/A
- **Temperament Score:** 3/10 (Cautious & Risk-Averse)

## 2. Bio & Investment Criteria
- **Bio:** DC policy attorney investing in affordable housing syndications. Measures social impact metrics alongside financial returns.
- **Target Return:** 7.5% Pref Return + Impact Metrics
- **Strategy:** Impact Passive LP Allocation
- **Check Size Range:** $40,000 – $200,000
...
> "As Rosa Castillo, operating Castillo Legacy Investments LLC out of Washington, DC, I evaluate software strictly by how fast it gets me from raw lead to closed deal. My focus is Impact Passive LP Allocation with a target check size of $40,000 to $200,000."
...
### Project Creation UX
- Successfully created 10 projects tailored to Washington, DC on production Firestore. Document uploads with synthetic PDF scope watermarks uploaded instantly.
