...
export function IRRExitAssumptionsTerminal({
  ...
  const [annualCF, setAnnualCF] = useState(defaults.annualCashFlow ?? 1722);
  ...
  const [loanAmount, setLoanAmount] = useState(defaults.loanAmount ?? 219000);
  const [loanRate, setLoanRate] = useState(defaults.loanRate ?? 7);
