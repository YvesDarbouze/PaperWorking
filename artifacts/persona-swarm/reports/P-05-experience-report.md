# Persona Experience Report — Danny Reyes (P-05)

## 1. Agent Overview
- **Persona ID:** P-05
- **Full Name:** Danny Reyes
- **Email:** agent05.danny.reyes@paperworking-test.dev
- **Entity / LLC:** Reyes Rebuild Group LLC
- **Category:** house_flipper
- **Primary Market:** Phoenix, AZ
- **Investor Archetype:** High-Volume Cosmetic Flipper
- **Subscription Tier:** Individual ($59/mo)
- **Plaid Sandbox:** N/A
- **Temperament Score:** 6/10 (Cautious & Risk-Averse)

## 2. Bio & Investment Criteria
- **Bio:** High-volume Phoenix cosmetic flipper, 15 flips/year. Needs tight rehab budget tracking, milestone draw approvals, and instant hard money loan calculator integration.
- **Target Return:** 22% Net ROI
- **Strategy:** Cosmetic Fix & Flip
- **Check Size Range:** $50,000 – $350,000
- **Asset Focus:** Single Family
...
> "As Danny Reyes, operating Reyes Rebuild Group LLC out of Phoenix, AZ, I evaluate software strictly by how fast it gets me from raw lead to closed deal. My focus is Cosmetic Fix & Flip with a target check size of $50,000 to $350,000."
