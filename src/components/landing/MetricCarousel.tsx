    ...
    <section className="relative py-24 bg-background overflow-hidden border-t border-b border-white/5">
      ...
      <div className="max-w-[1280px] mx-auto px-6 md:px-10">
        ...
        <div className="max-w-3xl mb-12">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/10 border border-primary/20 text-xs font-semibold text-primary mb-6 type-eyebrow">
          ...
          <p className="text-base sm:text-lg text-on-surface-variant leading-relaxed font-normal mb-6 type-body-lg">
          ...
          <Link
            ...
            className="inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-primary hover:underline group cursor-pointer text-decoration-none type-cta"
          >
          ...
          {HERO_KPIS.map((kpi, idx) => {
            ...
            return (
              <button
                ...
                className={`px-4 py-2 rounded-lg text-xs font-semibold whitespace-nowrap transition-all duration-150 cursor-pointer type-cta ${
                  isActive
        ...
        <div className="relative glass-card border border-white/8 bg-surface-container-low/20 backdrop-blur-xl rounded-2xl p-6 md:p-10 min-h-[500px] flex flex-col lg:flex-row gap-10 items-center justify-between">
          ...
          <button
            onClick={handlePrev}
            className="absolute left-4 top-1/2 -translate-y-1/2 z-10 w-10 h-10 flex items-center justify-center rounded-full bg-surface-container-high/80 border border-white/10 text-on-surface hover:bg-surface-container-highest transition-all shadow-md cursor-pointer type-cta"
          ...
          <button
            onClick={handleNext}
            className="absolute right-4 top-1/2 -translate-y-1/2 z-10 w-10 h-10 flex items-center justify-center rounded-full bg-surface-container-high/80 border border-white/10 text-on-surface hover:bg-surface-container-highest transition-all shadow-md cursor-pointer type-cta"
          ...
          <div className="flex-1 max-w-xl space-y-6 px-4 md:px-8">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 flex items-center justify-center rounded-xl bg-primary/10 border border-primary/20 text-base font-extrabold text-primary font-jetbrains type-metric">
                {activeKpi.symbol}
              </div>
              <div>
                <h3 className="text-2xl font-bold text-on-surface leading-tight type-h3">
                  {activeKpi.name}
                </h3>
                <div className="text-[12px] font-semibold text-primary/95 tracking-wide italic mt-0.5 type-caption">
                  {activeKpi.tagline}
                </div>
              </div>
            </div>
            ...
            <ul className="space-y-3">
              {activeKpi.bullets.map((bullet, idx) => (
                <li key={idx} className="flex items-start gap-2.5 text-xs text-on-surface-variant/90 leading-relaxed type-small">
            ...
            <div className="pt-4 border-t border-white/5 space-y-2">
              <div className="text-[10px] uppercase tracking-widest text-on-surface-variant/50 font-bold type-eyebrow">Standard Formula</div>
              <div className="text-xs font-mono text-white bg-white/5 px-3 py-2 rounded-lg border border-white/5 inline-block type-caption">
                {activeKpi.formula}
              </div>
            </div>
          </div>
                  ...
                  <div className="w-full rounded-2xl border border-white/10 bg-pw-night-bg shadow-2xl overflow-hidden font-hanken">
                    ...
                    <div className="flex items-center justify-between px-4 py-3 bg-[#1e1b22] border-b border-white/5">
                      ...
                      <div className="flex items-center gap-1.5 px-3 py-1 bg-black/40 border border-white/5 rounded-md text-[10px] text-on-surface-variant/60 w-52 justify-center font-mono select-none">
                        ...
                        <span className="truncate">paperworking.co/insights</span>
                      </div>
