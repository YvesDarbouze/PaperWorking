...
export default function BlogPostPage() {
  ...
  return (
    <div className="min-h-screen bg-bg-surface pb-32">
      <MarketingNavbar />
      ...
      <main className="max-w-[800px] mx-auto px-12 py-32">
        ...
        <div className="flex items-center gap-8 mb-16">
          <Link 
            href="/blog"
            className="flex items-center gap-2 text-xs font-black text-text-secondary uppercase tracking-[0.2em] hover:text-text-primary transition-all"
          >
        ...
        {/* Header Block */}
        <div className="mb-20">
          <h1 className="text-5xl sm:text-6xl font-black tracking-tighter text-text-primary leading-none uppercase mb-12">
            {post.title}
          </h1>
          <div className="flex flex-wrap items-center gap-12 text-xs font-black uppercase tracking-[0.2em] text-text-secondary border-y border-pw-dashboard py-8">
        ...
        {isCaseStudy && post.caseStudyData && (
          <section className="mb-32 space-y-12">
            <div className="border border-border-accent p-2 bg-pw-dashboard">
              <BeforeAfterSlider 
            ...
            <div className="border border-border-accent bg-pw-dashboard p-12">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-12 mb-16">
                  <div>
                    <p className="text-xs font-black text-text-secondary uppercase tracking-[0.4em] mb-3">Audit Metric 04.A</p>
                    <h3 className="text-3xl font-black tracking-tighter text-text-primary uppercase">Capital Settlement</h3>
                  </div>
                ...
                <div className="mt-16 pt-12 border-t border-border-accent flex justify-between items-center">
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      <p className="text-xs font-black text-text-secondary uppercase tracking-[0.2em]">Net Procurement Delta</p>
        ...
        <div className="bg-pw-black p-16 text-center text-white border border-pw-black group hover:bg-bg-surface hover:text-text-primary transition-all">
          ...
          <Link 
            href="/#"
            className="inline-block px-12 py-5 bg-bg-surface text-text-primary font-black text-xs uppercase tracking-[0.3em] hover:bg-pw-black hover:text-white border border-white transition-all"
          >
...
function FormulaItem({ label, value, highlight = false }: { label: string; value: number; highlight?: boolean }) {
  return (
    <div>
      ...
      <p className={`text-2xl font-black tracking-tighter ${highlight ? 'text-text-primary' : 'text-text-secondary'}`}>
