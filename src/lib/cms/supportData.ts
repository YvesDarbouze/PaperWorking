...
export const SUPPORT_ARTICLES: SupportArticle[] = [
  ...
  },
  {
    ...
    readTime: '5 min',
    content: '<p>Robust underwriting is the foundation of any successful deal. Before you submit an offer, you need hard numbers — not gut feelings.</p><h3>Setting Your Baseline Metrics</h3><p>Navigate to your Deal workspace and open the <strong>Underwriting Calculator</strong>. Enter your target acquisition price, estimated renovation budget, and projected After-Repair Value (ARV). The platform automatically calculates your Maximum Allowable Offer (MAO) using the 70% rule as a starting point.</p><h3>Key Metrics to Configure</h3><ul><li><strong>Cash-on-Cash Return</strong> — Your annual pre-tax cash flow divided by total cash invested. Most experienced investors target 8–12% minimum.</li><li><strong>Cap Rate</strong> — Net Operating Income divided by purchase price. Useful for comparing rental hold deals across different markets.</li><li><strong>Internal Rate of Return (IRR)</strong> — Accounts for the time value of money across your entire hold period. This is the metric sophisticated LPs care about most.</li></ul><h3>Risk Scoring</h3><p>PaperWorking assigns each deal a risk profile based on your inputs: renovation scope, market volatility, and financing terms. Deals that exceed your configured risk thresholds are flagged before you commit capital.</p>',
  },
  {
  ...
  // Phase 2: Purchase (acquisition)
  {
    ...
    readTime: '3 min',
    content: '<p>Missing a contingency deadline can put your Earnest Money Deposit at risk — and that is money you do not get back. The Contingency Tracker in PaperWorking ensures every critical date is visible from the moment your offer is accepted.</p><h3>How It Works</h3><p>When you transition a deal into Phase 2, the platform creates deadline cards for your three standard contingencies: <strong>Inspection</strong>, <strong>Financing</strong>, and <strong>Appraisal</strong>. Each card counts down to its expiration date.</p><h3>Setting Up Alerts</h3><p>Configure push notifications and email reminders at 7-day, 3-day, and 1-day intervals. Your team members and assigned attorney also receive reminders — so no one is caught off guard.</p><h3>Extending or Waiving</h3><p>If you need more time, log the extension directly in the tracker with the seller\'s acknowledgment date. If you choose to waive a contingency, the platform records it with a timestamp so your decision trail is always clear.</p>',
  },
  {
  ...
  // Phase 3: Hold (rehab)
  {
    ...
    readTime: '6 min',
    content: '<p>The moment you close on a property, the holding cost clock starts. Every day you own the asset before disposition, you\'re paying for it — and those costs compound faster than most investors realize.</p><h3>Automatic Cost Tracking</h3><p>PaperWorking begins calculating your daily burn rate from the recorded closing date. The platform tracks five recurring cost categories automatically: <strong>Property Taxes</strong>, <strong>Insurance</strong>, <strong>Utilities</strong>, <strong>HOA/Condo Fees</strong>, and <strong>Loan Interest</strong>.</p><h3>Setting Up Recurring Entries</h3><p>Navigate to the <strong>Holding Costs</strong> tab in your Phase 3 workspace. Enter the monthly amount for each category. The platform prorates them daily and rolls the totals into your running cost basis.</p><h3>Why This Matters</h3><p>Most investors underestimate holding costs by 15–25%. A property that sits on the market two months longer than planned can turn a profitable flip into a break-even deal. The burn rate dashboard shows you exactly how much each additional day costs — so you can make informed decisions about pricing and timing.</p>',
  },
  {
  ...
  },
  {
    ...
    readTime: '5 min',
    content: '<p>Reconciliation catches the errors that slip through manual logging. By matching platform transactions with your actual bank activity, you ensure your books reflect reality.</p><h3>How It Works</h3><p>Connect your project bank account or upload a statement CSV. The reconciliation tool displays unmatched transactions side by side: platform entries on the left, bank entries on the right.</p><h3>Matching Transactions</h3><p>Click to match corresponding entries. The platform suggests likely matches based on amount and date. Confirmed matches are marked as reconciled.</p><h3>Catching Discrepancies</h3><p>Unmatched entries highlight potential problems: expenses you forgot to log, duplicate entries, or unauthorized charges. Address each discrepancy before closing the reporting period.</p>',
  },
  {
