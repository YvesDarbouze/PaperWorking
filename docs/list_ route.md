...
| `/dashboard/deal-calculator` (historical redirect from `/dashboard/deal-analyzer`) | paperworking-v1 |
...
| `/projects/[id]/analyzer` (historical v0 route) | paperworking-v0 |
...
| `/api/deal-calculator/property-lookup` (historical alias `/api/deal-analyzer/property-lookup` preserved) | paperworking-v1 |
