...
export function getCategoryByFilename(filename: string): DocumentCategory {
  ...
  if (lower.includes('pof') || lower.includes('proof_of_funds') || lower.includes('offer')) return 'acquisition';
  if (lower.includes('loan') || lower.includes('title') || lower.includes('closing_disclosure') || lower.includes('inspection')) return 'purchase';
  if (lower.includes('rehab') || lower.includes('receipt') || lower.includes('lease') || lower.includes('utility')) return 'hold';
  if (lower.includes('sale') || lower.includes('marketing') || lower.includes('staging')) return 'exit';
  if (lower.includes('irs') || lower.includes('1040') || lower.includes('schedule') || lower.includes('1099') || lower.includes('tax')) return 'tax';
  return 'general';
}
