...
export default function TermsPage() {
  return (
    <main className="min-h-screen bg-bg-primary px-6 py-20 max-w-3xl mx-auto">
      ...
      <h1 className="mt-10 text-4xl font-normal tracking-tighter text-text-primary">Governance Protocols</h1>
      <p className="mt-4 text-sm text-text-secondary">Terms of Service · Last updated April 2026</p>
      <div className="mt-12 space-y-8 text-sm text-text-secondary leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-semibold text-text-primary mb-3">3. Confidentiality</h2>
        ...
        <section>
          ...
          <p>For questions about these terms, contact <a href="mailto:legal@paperworking.co" className="text-text-primary underline">legal@paperworking.co</a>.</p>
        </section>
      </div>
    </main>
  );
