...
export const LoanProcessingPipeline: React.FC = () => {
  ...
  return (
    <div className="p-6 bg-white rounded-xl shadow-sm border border-gray-100 h-full">
      <h2 className="text-xl font-semibold mb-6 text-gray-800">Loan Processing Pipeline</h2>

      <div className="flex justify-between items-center bg-gray-50 p-2 rounded-lg border border-gray-200 mb-8 overflow-x-auto gap-2">
      ...
      <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
        <h3 className="text-lg font-medium text-gray-800 mb-4">Lender Document Sub-Vault</h3>
        ...
        <div className="space-y-3 max-h-[300px] overflow-y-auto pr-2">
          {loanDocs.length === 0 ? (
            <p className="text-sm text-gray-500 italic text-center py-4 bg-white rounded border border-dashed border-gray-200">No lender documents uploaded yet.</p>
          ) : (
            loanDocs.map(doc => (
