  ...
  return (
    <div
      ...
      className={`
        ...
        hover:border-emerald-500/40 hover:shadow-xl hover:shadow-emerald-500/5
        group
        ${className}
      `}
      ...
      <div className="p-5 space-y-4 flex-1 flex flex-col justify-between">
        <div>
          ...
          <div className="grid grid-cols-2 gap-3 mb-4">
            <div className="p-2.5 rounded-xl bg-emerald-500/5 border border-emerald-500/15 flex items-center justify-between">
              <span className="text-[10px] font-bold uppercase text-slate-400">Cash-on-Cash</span>
              <span className="text-sm font-extrabold font-mono text-emerald-400">{metrics.cashOnCash}%</span>
            </div>
            <div className="p-2.5 rounded-xl bg-emerald-500/5 border border-emerald-500/15 flex items-center justify-between">
              <span className="text-[10px] font-bold uppercase text-slate-400">Cap Rate</span>
              <span className="text-sm font-extrabold font-mono text-emerald-400">{metrics.capRate}%</span>
            </div>
          </div>
        ...
        <div className="pt-3 border-t border-pw-border/50 flex items-center justify-between gap-2 mt-2">
          <button
            ...
            type="button"
            className="px-3 py-2 rounded-lg border border-pw-border text-[11px] font-bold text-slate-300 hover:bg-white/5 hover:border-emerald-500/30 transition-all flex items-center gap-1.5 min-h-[36px]"
          >
