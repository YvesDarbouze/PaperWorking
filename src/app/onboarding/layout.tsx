...
export default function OnboardingLayout({
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#0d0a0b] selection:bg-primary/30 overflow-hidden">
      ...
      {/* ── Top Brand Bar ── */}
      <header className="fixed top-0 w-full z-50 bg-[#0d0a0b]/80 backdrop-blur-xl border-b border-white/10 h-16 flex items-center justify-center px-5 md:px-10">
        <span className="text-[20px] font-bold text-[#454955] tracking-tight font-sans">
          PaperWorking
        </span>
      </header>
