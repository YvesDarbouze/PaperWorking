  ...
  return (
    ...
    >
      <div className="flex items-start gap-4">
        ...
        <ChevronRight
          className="w-4 h-4 text-[#A5A5A5] group-hover:text-[#1A1A1A] transition-colors flex-shrink-0 mt-1"
          aria-hidden="true"
        />
      </div>
...
function ListingMiniCard({ listing }: { listing: any }) {
  ...
  return (
    <div className="bg-[#F2F2F2] border border-[#A5A5A5]/30 rounded-lg p-3 flex gap-3">
      ...
      <div className="flex-1 min-w-0">
        <p className="text-xs font-semibold text-[#1A1A1A] truncate">{listing.UnparsedAddress}</p>
  ...
  return (
    <div className="bg-[#FFFFFF] border border-[#A5A5A5]/50 rounded-xl overflow-hidden">
      ...
      <div className="flex items-center justify-between px-5 py-4 border-b border-[#A5A5A5]/20">
        <h2 className="text-sm font-bold text-[#1A1A1A] tracking-tight">Agent Profile</h2>
        <button
          onClick={onClose}
      ...
      {loading ? (
        ...
        <div className="p-5 space-y-5">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="text-base font-semibold text-[#1A1A1A] tracking-tight">{agent.name}</h3>
              {agent.officeName && (
          ...
          <div className="flex gap-2">
            ...
            {agent.phone && (
              <a
                ...
                className="flex-1 flex items-center justify-center gap-2 py-2 px-3
                           bg-[#F2F2F2] border border-[#A5A5A5] text-[#1A1A1A]
      ...
      <div className="px-5 py-4 border-b border-[#A5A5A5]/20">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h2 className="text-sm font-bold text-[#1A1A1A] tracking-tight">Agent Directory</h2>
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-9 py-2.5 bg-[#F2F2F2] border border-[#A5A5A5]/30 rounded-lg
                       text-sm text-[#1A1A1A] placeholder:text-[#A5A5A5]
          ...
          {query && (
            <button
              ...
              className="absolute right-3 top-1/2 -translate-y-1/2 text-[#A5A5A5] hover:text-[#1A1A1A]"
        ...
        <div className="flex-1 p-4 max-h-[520px] overflow-y-auto no-scrollbar">
          ...
          {!loading && !error && agents.length === 0 && query.length >= 2 && (
            <div className="text-center py-12">
              ...
              <p className="text-sm font-semibold text-[#1A1A1A]">No agents found</p>
          ...
          {!loading && !error && agents.length === 0 && query.length < 2 && (
            <div className="text-center py-12">
              ...
              <p className="text-sm font-semibold text-[#1A1A1A]">Find your agent</p>
