# Persona Experience Report — Amara Osei (P-42)

## 1. Agent Overview
- **Persona ID:** P-42
- **Full Name:** Amara Osei
- **Email:** agent42.amara.osei@paperworking-test.dev
- **Entity / LLC:** Osei Generational Holdings LLC
- **Category:** family_office
- **Primary Market:** Miami, FL
- **Investor Archetype:** Multi-Family Office Principal
- **Subscription Tier:** Individual ($59/mo)
- **Plaid Sandbox:** N/A
- **Temperament Score:** 7/10 (Highly Analytical & Detail-Oriented)

## 2. Bio & Investment Criteria
- **Bio:** Miami MFO principal managing generational real estate equity. Focuses on Florida and Sunbelt growth markets.
- **Target Return:** 16% Net IRR
- **Strategy:** Sunbelt Multi-Family Office Equity
- **Check Size Range:** $400,000 – $4,000,000
...
> "As Amara Osei, operating Osei Generational Holdings LLC out of Miami, FL, I evaluate software strictly by how fast it gets me from raw lead to closed deal. My focus is Sunbelt Multi-Family Office Equity with a target check size of $400,000 to $4,000,000."
